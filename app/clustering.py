...
from .plotting import (clusters_chart, plot_dist_matrix, plot_distance_histogram,
                       plot_size_histogram)
...
def show_cluster(session_state):
    ...
    with st.expander('Distance between points statistics'):
        st.write("""Statistics for all pairwise cosine distance between titles in cluster:
